...
export const pageMetadata = {
  ...
  privacy: {
    title: 'Черновик политики конфиденциальности — kupitnezabyt',
    description:
      'Черновик политики обработки персональных данных сервиса kupitnezabyt для последующего юридического утверждения.',
  },
  terms: {
    title: 'Черновик условий использования — kupitnezabyt',
    description:
      'Черновик условий использования сервиса kupitnezabyt для последующего юридического утверждения.',
  },
  notFound: {
